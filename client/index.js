...
function insertRowIntoTable(data) {
  ...
  tableHtml += `<td><button class="edit-row-btn btn btn-success" data-id="${data.id}" data-email="${data.email}" data-name="${data.name}" data-gender="${data.gender}" data-password="${data.password}" data-confirmpassword="${data.confirmpassword}">Edit-input-fields</td>`;
